    ...
    <div v-if="store.showExitConfirm" class="modal-overlay" style="z-index: 3000;">
        ...
        <div v-if="store.showExitConfirm" class="glass-card exit-top-banner">
            ...
            <div class="banner-right">
                <button @click="store.showExitConfirm = false" class="glass-btn secondary-btn small-btn">
                    取消手滑
                </button>
                <button @click="actions.confirmExitToMainMenu" class="glass-btn primary-btn danger-btn small-btn">
                    🗑️ 确定退出
                </button>
            </div>
